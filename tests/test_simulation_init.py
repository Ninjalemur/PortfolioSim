...
def test_simulation_get_portfolio_value():
    """
    ensure that simulation retrieves portfolio values correctly
    via _get_portfolio_value
    """
    ...
    expected_portfolio_value = 1000

    assert x._get_portfolio_value() == expected_portfolio_value
